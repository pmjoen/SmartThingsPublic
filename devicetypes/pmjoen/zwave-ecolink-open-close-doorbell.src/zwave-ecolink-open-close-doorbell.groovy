/**
 *  Z-Wave Ecolink Open/Close Doorbell
 *
...
metadata {
	...
	definition (name: "Z-Wave Ecolink Open Close Doorbell", namespace: "pmjoen", author: "SmartThings") {
	...
	tiles(scale: 2) {
		multiAttributeTile(name:"contact", type: "lighting", width: 6, height: 4, canChangeIcon: true){
			tileAttribute ("device.contact", key: "PRIMARY_CONTROL") {
				attributeState "open", label:'Ding Dong', icon:"st.Food & Dining.dining8", backgroundColor: "#FF0000"
				attributeState "closed", label:'Quiet', icon:"st.Food & Dining.dining8", backgroundColor: "#ffffff"
			}
