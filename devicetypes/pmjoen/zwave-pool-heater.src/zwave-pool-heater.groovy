...
metadata {
	...
	definition (name: "Z-Wave Pool Heater", namespace: "pmjoen", author: "SmartThings") {
		capability "Actuator"
		capability "Switch"
		capability "Polling"
		capability "Refresh"
	...
	tiles {
		standardTile("switch", "device.switch", width: 2, height: 2, canChangeIcon: true) {
			state "on", label: 'Heating', action: "switch.off", icon: "st.thermostat.heating", backgroundColor: "#79b821"
